...
module.exports = {
	...
	theme: {
		...
		backgroundImage: {
			...
			'gradient-casheer-invoice-text-center': 'linear-gradient(91deg, #7D00E2 0%, #FFF 40%, #7D00E2 100%)',
			'gradient-casheer-checkout-text-center': 'linear-gradient(91deg, #5066F6 0%, #FFF 40%, #5066F6 100%)',
			'gradient-casheer-TapAndGo-text-center': 'linear-gradient(91deg, #1CF4FF 0%, #FFF 40%, #1CF4FF 100%)',
			'gradient-casheer-WalletAndCard-text-center': 'linear-gradient(91deg, rgba(24, 254, 106, 0.81) 0%, #FFF 40%, rgba(24, 254, 106, 0.81) 100%);',
