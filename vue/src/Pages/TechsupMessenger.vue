<template>
  ...
  <div class="max-w-full">
      <div class="relative overflow-hidden bg-white dark:bg-gray-800 sm:rounded-xl">
          <div class="flex flex-col px-4 py-3 space-y-3 lg:flex-row lg:items-center lg:justify-between lg:space-y-0 lg:space-x-4">
              <div class="flex items-center flex-1 space-x-4">
                  <h5>
                      <span class="text-gray-500">Всего продуктов: </span>
                      <span class="dark:text-white">123456</span>
                  </h5>
                  <h5>
                      <span class="text-gray-500">Всего продаж: </span>
                      ...
                      <tr>
                          <th scope="col" class="p-4">
                              <div class="flex items-center">
                                  <input id="checkbox-all" type="checkbox" class="w-4 h-4 bg-gray-100 border-gray-300 text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                  <label for="checkbox-all" class="sr-only rounded">checkbox</label>
                              </div>
                          </th>
                          <th scope="col" class="px-4 py-3">Продукт</th>
                          <th scope="col" class="px-4 py-3">Категория</th>
                          <th scope="col" class="px-4 py-3">Остаток</th>
                          <th scope="col" class="px-4 py-3">Продажи/День</th>
                          <th scope="col" class="px-4 py-3">Продано/Месяц</th>
                          <th scope="col" class="px-4 py-3">Рейтинг</th>
                          <th scope="col" class="px-4 py-3">Продано</th>
                          <th scope="col" class="px-4 py-3">Доход</th>
                          <th scope="col" class="px-4 py-3">Время обновления</th>
                      </tr>
                  </thead>
                  <tbody>
...
import Messenger from "@/Widgets/Techsup/Messenger/Messenger.vue";
</script>